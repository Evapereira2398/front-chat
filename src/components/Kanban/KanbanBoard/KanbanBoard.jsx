  ...
  const [columns, setColumns] = useState([
    ...
    },
    {
      ...
      cards: [
        ...
        { id: 15, content: "Task 15" },
        { id: 16, content: "Task 16" },
        { id: 17, content: "Task 17" },
      ],
    },
    {
      id: 3,
      ...
      cards: [
        ...
        { id: 11, content: "Task 11" },
        { id: 12, content: "Task 12" },
        { id: 13, content: "Task 13" },
      ],
    },
  ]);
            ...
            <div className="confirmation-box">
              <div className="confirmation-box-content">
                ...
                <div className="confirmation-box-buttons">
                  <button
                    className="confirmation-box-button"
                    onClick={() => confirmDeleteColumn(columnToDeleteId)}
                  >
                    Sim
                  </button>
                  <button
